            ...
            steps {
                sshagent (credentials: ['codon-agent-ui-1']) {
                    sh '''
                        ...
                        ssh -o StrictHostKeyChecking=no ubuntu@54.225.22.116 "cd /home/ubuntu/codon-agents && /usr/bin/docker-compose down -v"
                        ...
                        ssh -o StrictHostKeyChecking=no ubuntu@54.225.22.116 "cd /home/ubuntu/codon-agents && /usr/bin/docker-compose up -d"
                    '''
                }
            }
        }
